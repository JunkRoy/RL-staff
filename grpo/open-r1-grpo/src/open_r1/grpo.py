...
logger = logging.getLogger("grpo.py")
...
def main(script_args, training_args, model_args):
    ...
    # Load the dataset
    logger.info(f"Loading dataset {script_args.dataset_name} with config {script_args.dataset_config}")
    ...
    logger.info("*** Initialize the GRPO trainer ***")
    import inspect
    file_location = inspect.getsourcefile(GRPOTrainer)
    logger.info(f"*** GRPO: {file_location}***")
    #############################
